...
`;
var cssStylesheet = `${cssKeyframes}
${cssAnimationClasses}`;
var motionTypeToCssClass = {
...
var triggerTypeToCssClass = {
  ...
  inView: "motionicon-trigger-mount"
  // Falls back to mount for CSS
};
function getCssAnimationClasses(motionType = "scale", trigger = "hover") {
  const classes = ["motionicon-animated"];
...
exports.cssAnimationClasses = cssAnimationClasses;
exports.cssKeyframes = cssKeyframes;
exports.cssStylesheet = cssStylesheet;
exports.getCssAnimationClasses = getCssAnimationClasses;
exports.injectCssAnimations = injectCssAnimations;
exports.motionTypeToCssClass = motionTypeToCssClass;
exports.removeCssAnimations = removeCssAnimations;
exports.triggerTypeToCssClass = triggerTypeToCssClass;
//# sourceMappingURL=chunk-KTPJ3FXL.js.map
//# sourceMappingURL=chunk-KTPJ3FXL.js.map